...
import styles from './MyTasksPage.module.css'; // ใช้ CSS ที่ปรับปรุงแล้ว
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faListCheck, faSpinner } from '@fortawesome/free-solid-svg-icons';
import ApprovalModal from '../../components/advisor/ApprovalModal'; 
...
    };
    ...
    // ฟังก์ชันเมื่อกดยืนยันการอนุมัติ/ตีกลับใน Modal
